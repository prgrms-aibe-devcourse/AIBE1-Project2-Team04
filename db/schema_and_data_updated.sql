...
-- Game 테이블 생성 (회원별 게임 정보 저장)
CREATE TABLE game (
    game_id BIGINT AUTO_INCREMENT PRIMARY KEY,
    member_id BIGINT NOT NULL,
    game_type VARCHAR(50) NOT NULL,  -- 게임 종류: LOL, VALORANT, TFT
    game_tier VARCHAR(50),           -- 게임별 티어
    game_position VARCHAR(50),       -- 게임별 포지션 (TFT는 NULL)
...
CREATE TABLE lecture (
    ...
    duration INTEGER,                       -- 강의 시간 (분)
    game_tier VARCHAR(255),                -- 해당 게임의 티어
    game_position VARCHAR(255),            -- 해당 게임의 포지션
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
